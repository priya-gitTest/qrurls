...
class QRURLs:
    ...
    def process(self, url: str, output_path: Optional[str] = None) -> Tuple[str, Optional[object]]:
        """
        Shorten URL and generate QR code
        
        Args:
            url: Original URL
            output_path: Optional path to save QR code. If None, auto-generates filename with timestamp
        ...
        qr_image = self.qr_generator.generate(short_url, output_path)
    ...
    def qr_only(self, url: str, output_path: Optional[str] = None):
            """
